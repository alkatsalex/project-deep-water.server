...
authRouter.get('/info/:id', auth, ctrlWrapper(getUserInfo));
authRouter.patch('/avatar/:id', auth, upload.single('avatar'), ctrlWrapper(updateAvatar));
authRouter.patch('/edit/:id', auth, ctrlWrapper(updateInfo));
